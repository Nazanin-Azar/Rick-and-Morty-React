...
function CharacterDetail({ selectedId, onAddFavorite, isAddToFavorite }) {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        console.log([episodeData].flat().slice(0, 5));
  ...
  return (
    <div style={{ flex: 1 }}>
    <CharacterSubInfo character={character} isAddToFavorite={isAddToFavorite} onAddFavorite={onAddFavorite} />
...
function CharacterSubInfo({character, isAddToFavorite, onAddFavorite}) {
  ...
  <div className="character-detail__info">
    ...
    {
      isAddToFavorite ? (<p>Already added to favorite ✅</p>) : (<button
